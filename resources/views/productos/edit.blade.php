                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-2 col-lg-offset-2 toppad" style="padding:10px 0px;" >
                                <div class="panel panel-info">
                                    <div class="panel-body">
                                        {!!  Form::model($producto, ['method' => 'PUT', 'route' => ['productos.listaproduct.update', $producto->id], 'class' => 'form-horizontal','id' => 'editForm', 'files' => true]) !!}
                                        <div class="panel-body">
                                            <div class="row text-center">
                                                <div class="row">
                                                    <img src="{{route('productos.listaproduct.photo', $producto->Thumbnail)}}" id="profileImage"  style="width: 200px;">
                                                </div>
                                            ...
                                            <div class="row text-center">
                                                <table class="table table-bordered table-striped table-hover">
                                                    ...
                                                    <tr>
                                                        <td>Referencia</td>
                                                        <td><input type="text" id="Referencia" name="Referencia" value="{{$producto->Referencia}}" style=" border: 1px solid #E4E4E4; width:100%; "></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Marca</td>
                                                        <td><input type="text" id="Marca" name="Marca" value="{{$producto->Marca}}" style=" border: 1px solid #E4E4E4; width:100%;"></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Descripción</td>

                                                        <td><textarea name="Descripcion" id="Descripcion" class="form-control" rows="5"  style=" border: 1px solid #E4E4E4; width:100%;" >{{$producto->Descripcion}}</textarea></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Precio</td>
                                                        <td><input type="text" id="Precio" name="Precio" value="{{$producto->Precio}}" style=" border: 1px solid #E4E4E4; width:100%; "></td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                            </div>
